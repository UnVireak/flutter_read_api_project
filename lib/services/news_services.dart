...
class NewsServices {
  ...
  static Future<NewsModel> readAPI() async {
    final String url =
        "https://newsapi.org/v2/everything?q=tesla&from=2024-05-18&sortBy=publishedAt&apiKey=$_key";
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        return compute(newsModelFromMap, res.body);
      } else {
